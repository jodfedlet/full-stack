...
function handleBeginAsync(event) {
    ...
    asyncOut.c(parentOut.aa_, parentOut.ab_, parentOut.ac_);
}
...
function createRendererFunc(templateRenderFunc, componentProps, renderingLogic) {
    ...
    var isImplicitComponent = componentProps.ag_ === true;
    ...
    return function renderer(input, out) {
        ...
        if (isServer) {
            ...
            if (!component) {
                ...
                if (isExisting === true) {
                    if (component.H_ === false || component.shouldUpdate(input, component.f_) === false) {
...
createRendererFunc._Y_ = resolveComponentKey;
createRendererFunc._Z_ = handleBeginAsync;