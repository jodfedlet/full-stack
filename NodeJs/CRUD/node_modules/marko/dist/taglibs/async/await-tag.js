...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === "function") {
        ...
        if (value !== undefined) {
            asyncValue.bN_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bN_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.bM_(error);
        }, timeout);

        asyncValue.bL_(function () {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bO_ || (out.global.bO_ = {
            instances: [],
            nextId: 0
        });
