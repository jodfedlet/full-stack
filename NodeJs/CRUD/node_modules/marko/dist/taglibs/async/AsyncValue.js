...
AsyncValue.prototype = {
     ...
     * available.
     */
    bL_: function (callback) {
        // Do we already have data or error?
        if (this.bK_) {
            // invoke the callback immediately
            return callback(this.bI_, this.aH_);
        }

        var callbacks = this.bJ_ || (this.bJ_ = []);
    ...
    bN_: function (value) {
        ...
        if (value && typeof value.then === "function") {
            ...
            var finalPromise = value.then(function onFulfilled(value) {
                nextTick(asyncValue.bN_.bind(asyncValue, value));
            }, function onRejected(err) {
                nextTick(asyncValue.bM_.bind(asyncValue, err));
            });
